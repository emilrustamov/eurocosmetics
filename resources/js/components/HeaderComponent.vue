    ...
    <div class="container mx-auto px-4 flex items-center justify-between">
      ...
      <nav class="menu flex-1 hidden md:flex justify-center">
        <ul class="flex justify-center space-x-10 text-[var(--gold)]">
          <li>
            <a href="#home" class="menu-link text-[16px] font-normal uppercase"
              @click.prevent="scrollToSection('#home')">
              {{ $t('menu.home') }}
            </a>
          </li>
          <li>
            <a href="#about" class="menu-link text-[16px] font-normal uppercase"
              @click.prevent="scrollToSection('#about')">
              {{ $t('menu.about') }}
            </a>
          </li>
          <li>
            <a href="#contact" class="menu-link text-[16px] font-normal uppercase"
